    ...
    `${process.env.WORDPRESS_URL}/${process.env.WORDPRESS_POST_API}`,
    {
      ...
      body: JSON.stringify({
        ...
        meta: {
          ...
          rem_toheat: OPTIONS_NUMBER[property.toheat],
